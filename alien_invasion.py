...
class AlienInvasion:
    ...
    def __update_bullets(self):
        """Обновляет позиции снарядов и уничножает старые снаряды."""
    ...
    def _create_fleet(self):
        ...
        """Опеределяет количество рядов, помещающихся на экране."""
    ...
    def _update_screen(self):
        ...
        # Кнопка Play отображается в том сулчае, если игра неативка.
